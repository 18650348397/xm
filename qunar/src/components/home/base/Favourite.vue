<template>
    <div class="favourite">
      ...
      <ul>
        <router-link tag="li" :to="{name:'detaillink',params:{id:item.id}}" class="item border-bottom" v-for="(item,index) in favList" :key="index">
          <img calss="item-img" :src="item.imgUrl" alt="">
          <div class="item-info">
            <h4>{{item.title}}</h4>
